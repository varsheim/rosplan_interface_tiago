#include "RPCheckDishwasher.h"

namespace KCL_rosplan {

    /* constructor */
    RPCheckDishwasher::RPCheckDishwasher(ros::NodeHandle &nh) {
        node_name = ros::this_node::getName();
        node_name_pretty = '(' + node_name + ')';
    }

    /* action dispatch callback */
    bool RPCheckDishwasher::concreteCallback(const rosplan_dispatch_msgs::ActionDispatch::ConstPtr& msg) {
        ...
        // Fill in goal here
        rosplan_tiago_hazard_detection::CheckDishwasherGoal goal;
        goal.sensor = "robot";
        ...
        // complete the action
        ROS_INFO("%s: CHECKDISHWASHER Action completing", node_name_pretty.c_str());
        return true;
    }
} // close namespace
...
int main(int argc, char **argv) {
    ...
    ros::init(argc, argv, "rosplan_check_dishwasher_action_client", ros::init_options::AnonymousName);
    ros::NodeHandle nh("~");

    // create PDDL action subscriber
    KCL_rosplan::RPCheckDishwasher rpti(nh);
