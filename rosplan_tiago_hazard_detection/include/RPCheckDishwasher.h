...
#include <rosplan_tiago_hazard_detection/CheckDishwasherAction.h>
...
typedef actionlib::SimpleActionClient<rosplan_tiago_hazard_detection::CheckDishwasherAction> Client;
