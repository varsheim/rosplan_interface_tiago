...
namespace KCL_rosplan {
    ...
    bool RPLeaveLoad::concreteCallback(const rosplan_dispatch_msgs::ActionDispatch::ConstPtr& msg) {
        ...
        // complete the action
        ROS_INFO("%s: LEAVELOAD Action completing", node_name_pretty.c_str());
        return true;
    }
} // close namespace
...
int main(int argc, char **argv) {
    ...
    ros::init(argc, argv, "rosplan_leave_load_action_client", ros::init_options::AnonymousName);
    ros::NodeHandle nh("~");

    // create PDDL action subscriber
    KCL_rosplan::RPLeaveLoad rpti(nh);
